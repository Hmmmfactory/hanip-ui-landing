...
| 본문 | H2 는 질문 또는 명사구, 3~5개. FAQ·출처를 제외한 본문은 최소 1,000자(권장 1,200~1,800자)로 쓴다. 각 H2 아래 문단은 3~4문장으로 실제 상황과 선택의 맥락을 충분히 남긴다. 40~80자짜리 **혼자 떼어내도 뜻이 통하는 문장**을 H2 마다 하나씩 |
